...
def compute_footend_3d(q1, q2, q3):
    Iy, Iz = compute_footend_2d(q1, q2)
    I = rotation(q3, Iy, Iz)

    return I

def computer_joint_3d(q1, q2, q3):
    A2d, B2d, C2d, D2d, E2d, F2d, G2d, H2d = compute_joint_2d(q1, q2)
    
    A3d = rotation(q3, A2d[0], A2d[1])
    B3d = rotation(q3, B2d[0], B2d[1])
    C3d = rotation(q3, C2d[0], C2d[1])
    D3d = rotation(q3, D2d[0], D2d[1])
    E3d = rotation(q3, E2d[0], E2d[1])
    F3d = rotation(q3, F2d[0], F2d[1])
    G3d = rotation(q3, G2d[0], G2d[1])
    H3d = rotation(q3, H2d[0], H2d[1])

    return A3d, B3d, C3d, D3d, E3d, F3d, G3d, H3d

def rotation(theta, py, pz):
    """
    :param theta
    :param py
    :param pz
